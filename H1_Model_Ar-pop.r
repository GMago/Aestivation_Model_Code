...
p_vary<-list(um=0.08,F=3) #To vary during fitting
...
p_start<-c(F=2,um=0.08)              #Intial parameters guesses
Model_Used<-Vector_2qn_seasonal_Eff  

MCMC <- modMCMC(p=p_start,f=Log_LKL_poisson_2Eqn_Pop,niter=100000,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=100,ntrydr=2,burninlength=10000,jump=p_start*0.5)
#MCMC <- modMCMC(p=p_start,f=Gaussian_Aestivation_2Eqn_pop,niter=1100,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=100,ntrydr=2,burninlength=100,jump=p_start*0.1)
...
Save_plots_results_basic(LBq,LBq50,UBq50,UBq,p_mcmc,file_name='H1_iAr',path_name,y_lim=10)
