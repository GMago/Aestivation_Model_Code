...
p_start<-c(F=2,um=0.035,T_val=80)              #Intial parameters guesses
...
MCMC <- modMCMC(p=p_start,f=Log_LKL_poisson_2Eqn_Pop,niter=1100,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=50,burninlength=100,jump=p_start*0.25)
...
MCMC <- modMCMC(p=p_start,f=Log_LKL_poisson_2Eqn_Pop,niter=5000,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=100,ntrydr=2,burninlength=1000,jump=p_start*0.1)

MCMC <- modMCMC(p=p_start,f=Log_LKL_poisson_2Eqn_Pop,niter=11000,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=50,burninlength=1000,jump=p_start*0.25)
...
Save_plots_results_basic(LBq,LBq50,UBq50,UBq,p_mcmc,file_name='H0',path_name,y_lim=60)
