...
p_start<-c(um=0.098,umd=0.01,F=13,d=0.08,w=0.5,T_val=80) #Intial parameters guesses
...
MCMC <- modMCMC(p=p_est,f=Posisson_Log_LKL_3Eqn_active,niter=110000,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=100,jump=p_est*0.25,burninlength=10000,ntrydr = 5)
...
Save_plots_results_aestivation(LBq,LBq50,UBq50,UBq,p_mcmc,file_name='H2',path_name,y_lim=60)
