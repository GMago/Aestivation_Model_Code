...
MCMC <- modMCMC(p=p_start,f=Log_LKL_Active_3Eqn_pop,niter=110000,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=100,ntrydr=2,burninlength=10000,jump=p_start*0.5)
...
path_name<-'~/Documemts/Results/Arabiensis_pop_'
Save_plots_results_aestivation(LBq,LBq50,UBq50,UBq,p_mcmc,file_name='H2_Ar',path_name,y_lim=10)
