...
p_start<-c(um=0.098,umd=0.01,F=2.55,d=0.02,w=1,T_val=80) #Intial parameters guesses
...
#MCMC <- modMCMC(p=p_est,f=Posisson_Log_LKL_3Eqn_Aestivation,niter=5000,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=30,ntrydr=2,jump=covIni)

MCMC <- modMCMC(p=p_est,f=Posisson_Log_LKL_3Eqn_Aestivation,niter=110000,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=50,jump=p_est*0.25,burninlength=10000,ntrydr = 2)
...
Save_plots_results_aestivation(LBq,LBq50,UBq50,UBq,p_mcmc,file_name='H3',path_name,y_lim=10.0)
