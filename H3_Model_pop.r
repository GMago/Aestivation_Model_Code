...
MCMC <- modMCMC(p=p_start,f=Log_LKL_Aestivation_3Eqn_pop,niter=110000,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=50,ntrydr=2,burninlength=10000,jump=p_start*0.25)
...
MCMC <- modMCMC(p=p_start,f=Log_LKL_Aestivation_3Eqn_pop,niter=11000,lower=LB,upper=UB,wvar0 = 1,var0=NULL,updatecov=50,ntrydr=2,burninlength=1000,jump=p_start*0.25)
...
Save_plots_results_aestivation(LBq,LBq50,UBq50,UBq,p_mcmc,file_name='H3x',path_name,y_lim=60)
